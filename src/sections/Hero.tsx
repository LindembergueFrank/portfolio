  ...
  return (
    <section className="hero shell" id="inicio" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <p className="lead">Trabalho com suporte, redes e sistemas internos no IPEM/RN. Desenvolvo principalmente com Java e Spring Boot, e uso Python e Django nos meus projetos de infraestrutura.</p>
